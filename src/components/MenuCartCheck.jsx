                ...
                <div className=" relative">
                    ...
                    {Carts.length === 0 ? <div className=' flex flex-col items-center justify-center'>
                        ...
                        <div className="bottons m-auto bg-white fixed bottom-0 p-5 flex justify-around justify-center items-center w-full">
                            <button onClick={() => {
                                handleCancelAlert();
                            }} className='bg-[#2563eb] h-12 w-32 text-white font-medium hover:bg-[#385492] flex items-center justify-center'>
                                Cancel
                            </button>
                            <Link onClick={() => {
                                dispatch(showCheckTost())
                            }} href='/cart' className='bg-[#2563eb] h-12 w-32 text-white font-medium hover:bg-[#385492] flex items-center justify-center'>
                                Check Cart
                            </Link>
                        </div>
                    </>}
